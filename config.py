...
RISK_PER_TRADE = 0.03  # 3% на сделку (УВЕЛИЧЕНО с 1%)
MAX_POSITIONS = 3       # Максимум 3 позиции одновременно

# Strategy Parameters - ДЛЯ МИНУТНОЙ ТОРГОВЛИ
TIMEFRAME = '15min'
EMA_SHORT = 8      # Короткие периоды для минутных свечей
EMA_MEDIUM = 21    # 5 минута
EMA_LONG = 50      # 50 минут

RSI_PERIOD = 14
RSI_OVERSOLD = 30
RSI_OVERBOUGHT = 70
ADX_PERIOD = 14
ADX_THRESHOLD = 40  # Ниже для минутных свечей
...
STOP_LOSS_PERCENT = 0.012   # 1.2% стоп (узкий для минутной торговли)
